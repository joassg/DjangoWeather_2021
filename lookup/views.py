...
def home(request):
	...
	if request.method == 'POST':
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=ECB9B09D-6F00-4120-9A54-DF2599A90D88")
		...
		elif apiapi[0]['Category']['Name'] == "Moderate":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=63122&distance=5&API_KEY=ECB9B09D-6F00-4120-9A54-DF2599A90D88")
